...
from src.utils.text_formatter import afrom typing import Optional
...
from src.services.moderation_service import ModerationService
from src.utils.emojis import E_ALERT, E_BAN, E_BELL, E_LOCK, E_SHIELD, E_STOP, E_WARN
from src.utils.permissions import is_super_admin  # Fully compatible with permissions.py
from src.utils.target_resolver import resolve_target
...
async def handle_undo_callback(
    ...
    if action == "unmute":
        ...
        await call.answer("✅ Warnings reset!")format_card, get_user_mention, mention_html
from src.utils.time_parser import format_duration, parse_time_string
